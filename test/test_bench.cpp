...
int main(int argc, char *argv[]) {
  using js_schema = ctrj::arr<ctrj::obj<
      ctrj::fld<__id, ctrj::str>,
      ctrj::fld<_index, ctrj::u64>,
      ctrj::fld<_guid, ctrj::str>,
      ctrj::fld<_isActive, ctrj::bol>,
      ctrj::fld<_balance, ctrj::str>,
      ctrj::fld<_picture, ctrj::str>,
      ctrj::fld<_age, ctrj::u64>,
      ctrj::fld<_eyeColor, ctrj::str>,
      ctrj::fld<_name, ctrj::str>,
      ctrj::fld<_gender, ctrj::str>,
      ctrj::fld<_company, ctrj::str>,
      ctrj::fld<_email, ctrj::str>,
      ctrj::fld<_phone, ctrj::str>,
      ctrj::fld<_address, ctrj::str>,
      ctrj::fld<_about, ctrj::str>,
      ctrj::fld<_registered, ctrj::str>,
      ctrj::fld<_latitude, ctrj::f64>,
      ctrj::fld<_longitude, ctrj::f64>,
      ctrj::fld<_tags, ctrj::arr<ctrj::str>>,
      ctrj::fld<_friends, ctrj::arr<ctrj::obj<
          ctrj::fld<_id, ctrj::u64>,
          ctrj::fld<_name, ctrj::str>
      >>>,
      ctrj::fld<_greeting, ctrj::str>,
      ctrj::fld<_favoriteFruit, ctrj::str>
  >>;
